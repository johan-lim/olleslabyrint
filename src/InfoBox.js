...
function InfoBox(props) {
    const inventory = {
        ...
        'shield': <img style={{ opacity: props.shieldHealth }} key="shield" alt="" className="pixelated key" src={shieldImage}/>,
        'hacka': <img style={{ opacity: props.hackaHealth }} key="hacka" alt="" className="pixelated key" src={hackaImage}/>,
        'fackla': <img key="fackla" alt="" className="pixelated key" src={facklaImage}/>,
